...
(define (quaternion-cos q)
  (if (quaternion? q)
  (quaternion-divide (quaternion-add (quaternion-exp (quaternion-multiply q (quaternion-divide (vector-part q) (quaternion-norm (vector-part q)))))
                                     (quaternion-exp (quaternion-multiply -1 q (quaternion-divide (vector-part q) (quaternion-norm (vector-part q)))))) 2)
  (cos q)))

(define (quaternion-sin q)
  (if (quaternion? q)
  (quaternion-divide (quaternion-subtract (quaternion-exp (quaternion-multiply q (quaternion-divide (vector-part q) (quaternion-norm (vector-part q)))))
                                          (quaternion-exp (quaternion-multiply -1 q (quaternion-divide (vector-part q) (quaternion-norm (vector-part q))))))
