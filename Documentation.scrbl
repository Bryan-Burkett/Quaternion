...
@subsection{Addition}
@defproc[(+ [x quaternion?/number?]...) quaternion?/number?]{Sums two or more numbers or quaternions by summing their components, or for only one argument returns that argument. If none of the arguments are quaternions, uses racket's + procedure.
                                                      @codeblock|{
