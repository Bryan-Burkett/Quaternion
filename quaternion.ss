...
(module quaternion mzscheme

  (define-struct quaternion (w x y z) (make-inspector))
  ...
  (provide 
    (all-from-except mzscheme 
                     ;the following are the Scheme
                     ;primitives that the quaternion
                     ;language redefines
